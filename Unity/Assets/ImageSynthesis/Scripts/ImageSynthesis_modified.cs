...
public class ImageSynthesis : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //capturePasses[1].camera = movingCamera.GetComponent<Camera>();
        //for (int q = 1; q < capturePasses.Length; q++)
        //    capturePasses[q].camera = CreateHiddenCamera(capturePasses[q].name);

        capturePasses[0].camera = CreateHiddenCamera("_depth");
    ...
    public void OnCameraChange()
    {
        ...
        //  SetupCameraWithReplacementShader(capturePasses[2].camera, uberReplacementShader, ReplacementMode.Normals);
